...
describe('Test forms elements functionality', () => {
  ...
  it('Check form submission with static text', () => {
    ...
    practiceFormPOM.fillStudentForm(userData).submitForm().checkSubmittedData(userData);
  });
  ...
  it('Check form submission with randomized data', () => {
    ...
    homepagePOM.clickCategoryCard('Forms').clickMenuItem('Practice Form');
    practiceFormPOM.fillStudentForm(randomStudent).submitForm().checkSubmittedData(randomStudent);
  });

  it('Check empty form submission shows required field errors', () => {
    homepagePOM.clickCategoryCard('Forms').clickMenuItem('Practice Form');
    practiceFormPOM.submitForm().checkRequiredFieldErrors();
  });

  it('Check form submission with an invalid email is rejected', () => {
    homepagePOM.clickCategoryCard('Forms').clickMenuItem('Practice Form');
    practiceFormPOM
      .fillStudentForm({ ...userData, email: userData.wrongEmail })
      .submitForm()
  ...
  it('Check form submission with a 9 digit mobile number is rejected', () => {
    homepagePOM.clickCategoryCard('Forms').clickMenuItem('Practice Form');
    practiceFormPOM
      .fillStudentForm({ ...userData, mobile: userData.shortMobile })
      .submitForm()
